...
if strcmp(cmnd_str,'initialize')
    ...
    % TOPOGRAPHY
    dat.h_topoB=axes('position',topo_ax_dim,'box','off','parent',uipan);
    ...
    tempH=uicontrol(dat.fig_id,...
        'Units','normalized', ...
        'Position',[ 0.02 0.185 0.09 0.03 ],... % Höhe war 0.183
        'String','Statistic:',...
        'fontsize',fontsize_bottom_ui, ...
        'BackgroundColor', frm_col, ...
            ...
            if ~sum(isnan(dat.critical_t)) && (stat==1) && ~isempty(dat.critical_t)
                for nw=1:dat.n_wind,
                    ...
                    if nw==1,
                        ...
                        tm_rng=double(dat.times(end)-dat.times(1));
                        if strcmpi(dat.mltplcmp_crct,'fdr')
